...
import { submitPartnershipFormTwo } from "../http/contactApi";
    ...
    <>
      <div className="header">
        <div className="title-block">
          ...
          <p className="pod">
            Продайте свою продукцию по максимально выгодным ценам
          </p>
        </div>
      </div>
                ...
                {!loading && !error && products.length === 0 && (
                  <div className="info-blockk">
                    <div className="text-contentt">
                      ...
                      <p>
                        Хотите узнать о возможности продать культуру первым?
                      </p>
                      <p>
                        Напишите в службу поддержки или позвоните оператору. Вас
                        уведомят заранее!
                      </p>
                    </div>
                    ...
                    >
                      ...
                      <img
                        ...
                        className={`expand-arrow ${
                          expandedBlocks[product.id] ? "open" : ""
                        }`}
                      />
                    </div>
      ...
      {isbuyform && (
        <div
          className="partnership-form formmob"
